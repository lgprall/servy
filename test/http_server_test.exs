defmodule HttpServerTest do
  ...
  test "POST /bears" do
    ...
    response = HTTPoison.post!("http://localhost:4000/bears", "name=Baloo&type=Brown", [{"Content-Type", "application/x-www-form-encoded"}])
  ...
  test "POST /api/bears" do
    response = HTTPoison.post!("http://localhost:4000/api/bears", '{"name": "Breezly", "type": "Polar"}', [{"Content-Type", "application/json"}])
